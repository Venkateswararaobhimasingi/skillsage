...
function InterviewSession({ selectedTopic, onGoBack }: InterviewSessionProps) {
   ...
   * This now redirects to the InterviewRoom page.
   */
  const startInterview = () => {
    ...
    // Redirect to the InterviewRoom page, passing the selected topic
        ...
        {!isInterviewActive ? (
          ...
          >
            ...
            <Button
              ...
              variant="gradient"
              // Disable if no mic/webcam selected or stream isn't ready
              disabled={!selectedMicId || !selectedWebcamId || !primaryMediaStream || primaryMediaStream.getVideoTracks().length === 0}
            >
            ...
            <p className="text-xs text-gray-500 mt-8 px-4">
              Mercor uses generative AI to conduct the AI interview. Your responses are used only to assess your candidacy and are never used to train AI models.
            </p>
          </motion.div>
        ) : (
