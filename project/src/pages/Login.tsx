...
import { Robot } from '@/components/three/Robot'; // 👈 Make sure path is correct
...
const handleGoogleLogin = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen w-full overflow-hidden">
      {/* Top (mobile) or Left (desktop): Spline */}
      <div className="w-full md:w-1/2 h-[300px] md:h-auto">
        <Robot />
      </div>

      {/* Bottom (mobile) or Right (desktop): Login Form */}
      <div className="flex items-center justify-center w-full md:w-1/2 px-4 py-8 md:p-6">
        <motion.div
